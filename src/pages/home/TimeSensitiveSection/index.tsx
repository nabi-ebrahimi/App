...
function TimeSensitiveSection() {
    ...
    const {discountInfo: earlyDiscountInfo, shouldShowEarlyDiscount} = useTimeSensitiveEarlyDiscount();
    ...
    // 4. First-24-hours early discount
    ...
    return (
        <WidgetContainer title={translate('homePage.timeSensitiveSection.title')}>
            <View style={styles.getForYouSectionContainerStyle(shouldUseNarrowLayout)}>
                ...
                {/* Priority 4: First-24-hours early discount */}
