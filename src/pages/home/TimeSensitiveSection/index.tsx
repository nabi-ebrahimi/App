...
function TimeSensitiveSection() {
    ...
    const {discountInfo, shouldShowEarlyDiscount} = useTimeSensitiveEarlyDiscount();
    ...
    // 7. Broken personal card connections
    ...
    return (
        <WidgetContainer title={translate('homePage.timeSensitiveSection.title')}>
            <View style={styles.getForYouSectionContainerStyle(shouldUseNarrowLayout)}>
                ...
                {/* Priority 4: Early discount */}
                {shouldShowEarlyDiscount && !!discountInfo && <EarlyDiscount discountInfo={discountInfo} />}
