...
function BaseOnboardingAccounting({shouldUseNativeStyles, route}: BaseOnboardingAccountingProps) {
    ...
    const [selectedIntegration, setSelectedIntegration] = useState<AccountingOptionKey | undefined>(isKnownIntegration ? (onboardingUserReportedIntegration as AccountingOptionKey) : onboardingUserReportedIntegration ? 'other' : undefined);
