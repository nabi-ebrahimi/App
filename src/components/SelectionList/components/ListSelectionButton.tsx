...
function ListSelectionButton<TItem extends ListItem>({
    ...
    // Paint the checkmark immediately on press, even when the parent defers the expensive
    // selection-state update in a startTransition. The optimistic value is dropped as soon as
    // the item.isSelected prop catches up (state-adjustment-during-render pattern).
